...
title.addEventListener("change", function (event) {
    ...
    formmodal2button.addEventListener("click", async (event) => {
        ...
        if (response.status !== 201) {
            ...
            inputphoto.value=""
            const image = document.getElementById('image');
            image.classList.remove("modal--window__container__photo__preview")
            image.classList.add("modal--window__container__photo__preview-none")
            const modalwindowcontainerphotoicon = document.getElementById('modalwindowcontainerphotoicon')
            modalwindowcontainerphotoicon.classList.remove("modal--window__container__photo__icon-none")
            const modalwindowcontainerphototxt = document.getElementById('modalwindowcontainerphototxt')
